...
const ActivityDeleteDialog = ({ params, show, onHide }) => {
  ...
  const onDeleteActivity = () => {
    ...
    dispatch(deleteActivity(params))
  }
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">
          <FormattedMessage id="ACTIVITY.DELETE.TITLE" />
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <FormattedMessage id="ACTIVITY.DELETE.MSG" />
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
