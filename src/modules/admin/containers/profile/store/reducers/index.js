...
export default (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case ACTIONS.FETCH_RECENT_APPOINTMENTS_INIT: {
      return { ...state, isFetching: true, appointments: [], error: null }
    }
    case ACTIONS.FETCH_RECENT_APPOINTMENTS_SUCCEDED: {
      return { ...state, recentAppointments: payload, isFetching: false, error: null }
    }
    case ACTIONS.FETCH_RECENT_APPOINTMENTS_FAILED: {
      return { ...state, isFetching: false, error: payload }
    }
