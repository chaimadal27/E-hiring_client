...
export const fetchMyAppointments = (params) =>
({
  type: CALL_API,
  meta: {
    actions: {
...
export const fetchMyRecentAppointments = (params) =>
({
  type: CALL_API,
  meta: {
    actions: {
      init: ACTIONS.FETCH_RECENT_APPOINTMENTS_INIT,
      success: ACTIONS.FETCH_RECENT_APPOINTMENTS_SUCCEDED,
      fail: ACTIONS.FETCH_RECENT_APPOINTMENTS_FAILED
    },
    endpoint: ENDPOINTS.RECENT_APPOINTMENTS,
    method: HTTP_METHODS.GET,
    params,
    auth: true
  }
