...
const ListShow = ({ history, match: { params }, intl, clearStore, error }) => {

    const suhbeader = useSubheader()
    // Tabs
    let title = intl.formatMessage({ id: "LIST.SHOW" })
            ...
            <Row>
                <Col xl="12" lg="12">
                    <Switch>
                        ...
                        <Redirect from="*" to={detailsRoutes.listDisplay.path.replace(":param", params.param)} />
                    </Switch>
                </Col>
            </Row>
        </>
...
const mapStateToProps = (state) => state.admin.list

export default connect(mapStateToProps, { clearStore })(injectIntl(ListShow))
