...
import { deleteAllBusinessUnits, fetchBusinessUnits } from "../../store/actions"


const BusinessUnitsDeleteDialog = ({params, show, onHide}) => {
    ...
    const onDeleteBusinessUnits = () => {
        dispatch(deleteAllBusinessUnits(params))
    }
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">
          <FormattedMessage id="BUSINESS_UNIT.MULTIPLE_DELETE.TITLE" />
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <FormattedMessage id="BUSINESS_UNIT.MULTIPLE_DELETE.MSG" />
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
