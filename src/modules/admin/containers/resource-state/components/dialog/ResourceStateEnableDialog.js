...
import {enableResourceState, fetchResourceStates} from "../../store/actions"

const ResourceStateEnableDialog = ({ params, show, onHide }) => {
  ...
  const onEnableresourceState = () => {
    // server request for deleting ResourceStates by id
    dispatch(enableResourceState(params))
  }
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">
          <FormattedMessage id="RESOURCE_STATE.ENABLE.TITLE" />
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <FormattedMessage id="RESOURCE_STATE.ENABLE.MSG" />
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
...
export default ResourceStateEnableDialog
