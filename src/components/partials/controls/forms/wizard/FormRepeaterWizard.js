...
import { FormRepeaterWizardStep } from "./FormRepeaterWizardStep"

const FormRepeaterWizard = (props) => {
    const { children, label, min = 1, max = 500, show = true, sortable = false } = props
...
export default FormRepeaterWizard