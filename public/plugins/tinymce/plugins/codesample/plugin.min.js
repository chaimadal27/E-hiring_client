...
!function(e){
    "use strict";var n,t,a,r=tinymce.util.Tools.resolve("tinymce.PluginManager"),
        i=function(e){return function(){return e;};},s=i(!1),o=i(!0),
        l=function(){return u;},u=(n=function(e){return e.isNone();},
            {fold:function(e,n){return e();},is:s,isSome:s,isNone:o,getOr:a=function(e){return e;},
                getOrThunk:t=function(e){return e();},getOrDie:function(e){throw new Error(e||"error: getOrDie called on none.");},
                getOrNull:i(null),getOrUndefined:i(undefined),or:a,orThunk:t,map:l,each:function(){},
                bind:l,exists:s,forall:o,filter:l,equals:n,equals_:n,toArray:function(){return[];},toString:i("none()")}),
        c=function(t){var e=i(t),n=function(){return r;},a=function(e){return e(t);},r={fold:function(e,n){return n(t);},
            is:function(e){return t===e;},isSome:o,isNone:s,getOr:e,getOrThunk:e,getOrDie:e,getOrNull:e,getOrUndefined:e,or:n,orThunk:n,
            map:function(e){return c(e(t));},each:function(e){e(t);},bind:a,exists:a,forall:a,filter:function(e){return e(t)?r:u;},
            toArray:function(){return[t];},toString:function(){return"some("+t+")";},equals:function(e){return e.is(t);},
            equals_:function(e,n){return e.fold(s,function(e){return n(t,e);});}};return r;},d={some:c,none:l,
            from:function(e){return null===e||e===undefined?u:c(e);}},p=tinymce.util.Tools.resolve("tinymce.dom.DOMUtils");
    function g(e){return e&&"PRE"===e.nodeName&&-1!==e.className.indexOf("language-");}function m(t){return function(e,n){return t(n);};}
    var f="undefined"!=typeof e.window?e.window:Function("return this;")(),h={},b={exports:h},y={};!function(n,t,a,d){var e=window.Prism;window.Prism={manual:!0},
        function(e){
        if("object"==typeof t&&void 0!==a)a.exports=e();else if("function"==typeof n&&n.amd)n([],e);
        else{("undefined"!=typeof window?window:void 0!==y?y:"undefined"!=typeof self?self:this).EphoxContactWrapper=e();}}
        (function(){return function c(i,s,o){function l(n,e){if(!s[n]){if(!i[n]){var t="function"==typeof d&&d;if(!e&&t)return t(n,!0);
            if(u)return u(n,!0);
            var a=new Error("Cannot find module '"+n+"'");throw a.code="MODULE_NOT_FOUND",a;}
            var r=s[n]={exports:{}};i[n][0].call(r.exports,function(e){return l(i[n][1][e]||e);},r,r.exports,c,i,s,o);}
            return s[n].exports;}for(var u="function"==typeof d&&d,e=0;e<o.length;e++)l(o[e]);return l;}
